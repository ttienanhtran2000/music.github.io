$(function()
{
	...
	var musics = [{
		artist: "Reddy (Đức Phúc)",
		name: "Ánh Nắng Của Anh",
		url: "Musics/Ánh Nắng Của Anh.mp3",
		picture: src="{% Background 'imahes/L.jpg' %}"
    },
    {
        artist: "Reddy (HuyR)",
        name: "Anh Thanh Niên",
        url: "Musics/Anh Thanh Niên.mp3",
        picture: src="{% Background 'imahes/L.jpg' %}"
    },
    {
        artist: "Reddy(Orange,Khói,ChâuĐăngKhoa)",
		name: "Chân Ái",
		url: "Musics/Chân Ái.mp3",
		picture: src="{% Background 'imahes/L.jpg' %}"
    },
    {
        artist: "Reddy (Katie Sky)",
		name: "I See Your Monster",
		url: "Musics/I See Your Monster.mp3",
		picture: src="{% Background 'imahes/L.jpg' %}"
    },
    {
        artist: "Reddy (j.Fa Cover)",
		name: "Shape Of You",
		url: "Musics/Shape Of You.mp3.mp3",
		picture: src="{% Background 'imahes/L.jpg' %}"
    },
    {
        artist: "Reddy (Reynard Silva)",
		name: "The Way I Still Love You",
		url: "Musics/The Way I Still Love You.mp3",
		picture: src="{% Background 'imahes/L.jpg' %}"
    },
    {
        artist: "Reddy (Lou Hoàng,Miu Lê)",
		name: "Yêu Một Người Có Lẽ",
		url: "Musics/Yêu Một Người Có Lẽ.mp3",
		picture: src="{% Background 'imahes/L.jpg' %}"
    },
    {
        artist: "Reddy (Phùng Khánh Linh)",
		name: "Hôm Nay Tôi Buồn",
		url: "Musics/Hôm Nay Tôi Buồn.mp3",
		picture: src="{% Background 'imahes/L.jpg' %}"
    },
    {
        artist: "Reddy (Đen,Phương Anh Đào)",
		name: "Lối Nhỏ",
		url: "Musics/Lối Nhỏ.mp3",
		picture: src="{% Background 'imahes/L.jpg' %}"
    },
    {
        artist: "Reddy (Đen,Min)",
		name: "Bài Này Chill Phết",
		url: "Musics/Bài Này Chill Phết.mp3",
		picture: src="{% Background 'imahes/L.jpg' %}"
    },
    {
        artist: "Reddy (Đức Phúc)",
		name: "Hết Thương Cạn Nhớ",
		url: "Musics/Hết Thương Cạn Nhớ.mp3",
		picture: src="{% Background 'imahes/L.jpg' %}"
    },
];
